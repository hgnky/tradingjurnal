...
export default function UpgradePage() {
  ...
  useEffect(() => {
    ...
    } else if (!isLoading && user && role !== 'free') {
      router.push('/dashboard') // sudah bayar, langsung redirect
    }
  }, [user, role, isLoading])
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <p className="text-muted-foreground">Your trial is limited. Upgrade now to unlock full access!</p>
